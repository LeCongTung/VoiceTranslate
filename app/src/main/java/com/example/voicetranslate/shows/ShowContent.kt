...
class ShowContent : AppCompatActivity() {
    ...
    var filteredNames = ArrayList<Example>()

    val myAdapter: AdapterExample by lazy { AdapterExample(newArrayList) } //Chi khoi tao khi duoc goi

    val exampleBank: Array<String> by lazy {
        arrayOf(
    ...
    val exampleBasic: Array<String> by lazy {
        arrayOf(
    ...
    val exampleBeautyCare: Array<String> by lazy {
        arrayOf(
    ...
    val exampleCallPolice: Array<String> by lazy {
        arrayOf(
    ...
    val exampleCommunication: Array<String> by lazy {
        arrayOf(
    ...
    val exampleFoodDrink: Array<String> by lazy {
        arrayOf(
    ...
    val exampleHealth: Array<String> by lazy {
        arrayOf(
    ...
    val exampleHotel: Array<String> by lazy {
        arrayOf(
    ...
    val exampleRestaurant: Array<String> by lazy {
        arrayOf(
    ...
    val exampleTransport: Array<String> by lazy {
        arrayOf(
    ...
    val exampleRepairLaundry: Array<String> by lazy {
        arrayOf(
    ...
    val exampleShopping: Array<String> by lazy {
        arrayOf(
    ...
    val exampleSightseeing: Array<String> by lazy {
        arrayOf(
    ...
    val exampleSport: Array<String> by lazy {
        arrayOf(
    ...
    val exampleStudying: Array<String> by lazy {
        arrayOf(
    ...
    val exampleTraveling: Array<String> by lazy {
        arrayOf(
        ...
        myAdapter.setOnItemClickListener(object : AdapterExample.onItemClickListener {
            override fun onItemClick(position: Int) {
                ...
                if (filteredNames.size == 0)
                    titleToContent = searchArrayList[position].example.toString()
                else
