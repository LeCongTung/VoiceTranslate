...
import com.example.voicetranslate.ui.adapters.AdapterExample
...
class ShowContentActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when {
            requestCode == 97 && resultCode == Activity.RESULT_OK -> {
                data?.let {
    ...
    private fun getDataExample() {
        ...
        myAdapter.setOnItemClickListener(object : AdapterExample.onItemClickListener {
            override fun onItemClick(position: Int) {
                ...
                val intent = Intent(this@ShowContentActivity, TranslateActivity::class.java)
